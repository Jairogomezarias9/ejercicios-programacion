...
bool applyOneRule(vector<char> &v, char follow)
{
    ...
    // E*E → E
    else if (n >= 2 and v[n - 2] == 'E' and v[n - 1] == '*' and v[n] == 'E')
    {
        v.pop_back();
        v.pop_back();
        return true;
    ...
    else if (n >= 3 and (follow != '*' or follow != '+') and v[n - 1] == 'E' and v[n - 2] == '<' and v[n - 3] == 'E')
    {
        v.pop_back();
        v.pop_back();
        return true;
    ...
    //(E)I → I  no es pot aplicar si ve seguida de e
    else if(n>=3 and v[n - 1] == 'I' and v[n - 2] == ')' and v[n - 3] == 'E' and v[n - 4] == '(' and follow!='e' ){
        v.pop_back();
        v.pop_back();
        v.pop_back();
        v.pop_back();
    ...
    //i(E)IeI → I 
    else if(n>=6 and v[n - 1] == 'I' and v[n - 2] == 'e' and v[n - 3] == 'I' and v[n - 4] == ')' and v[n - 5] == 'E' and v[n - 6] == '(' and v[n - 7] == 'i' ){
        v.pop_back();
        v.pop_back();
        v.pop_back();
        v.pop_back();
    ...
    //w(E)I → I 
    else if(n>=4 and v[n - 1] == 'I' and v[n - 2] == ')' and v[n - 3] == 'E' and v[n - 4] == '(' and v[n-5]=='w'){
        v.pop_back();
        v.pop_back();
        v.pop_back();
        v.pop_back();
    ...
    else if(n>1 and v[n-1]=='I' and (v[n-2]!=')' or v[n-2]!='L')){
        v[n-1]='L';
        return true;
    }

    //{L} → I 
    else if(n>=2 and v[n - 1] == '}' and v[n - 2] == 'L' and v[n - 3] == '{' ){
        v.pop_back();
        v.pop_back();
        v.push_back('I');
        return true;

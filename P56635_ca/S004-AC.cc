...
int relacio(const Rectangle &r1, const Rectangle &r2)
{
    ...
    else if(r2.x_esq>r1.x_dre or r2.x_dre<r1.x_esq or r2.y_baix>r1.y_dalt or r1.y_baix>r2.y_dalt){
   return 0;
    }
    else return 3;
}
...
int main()
{
    ...
    for (int i = 0; i < n; ++i)
    {
        ...
        if (r == 0)
        {
            cout<<"els rectangles no intersecten";
        }
        else if (r == 1)
        {
            cout << "el segon rectangle es interior al primer";
        }
        else if (r == 2)
        {
            cout << "el primer rectangle es interior al segon";
        }
        else if (r == 3)
        {
            cout<<"els rectangles intersecten";
        }
        else if(r==4)
        {
            cout << "els rectangles son iguals";
        }
        cout<<endl;
    }
}